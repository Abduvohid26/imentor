"""Prompts for startup AI endpoints — Django core/startup_ai_prompts.py bilan bir xil."""
...
def questionnaire_user_prompt(
    *, project_title: str, summary: str, full_description: str, structured_context_note: str, out_lang: str
) -> str:
